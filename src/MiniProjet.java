...
public class MiniProjet implements CommandListener{
  ...
  public static final String[]
    allCommandes = {"help", "clear", "exit", "print", "afficherFlotte", "afficherPersonnel", "ajouterVaisseau", "ajouterPersonnel", "modifierEquipage"};
  ...
  public void commandEntered(ArrayList<String> s) {
    switch(s.get(0)){
	  ...
	  case "modifierEquipage": 
		...
		} else log(s.get(1) + ": ce vaisseau ne fait pas partie de votre flotte."); break;
